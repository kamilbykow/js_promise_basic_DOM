...
let bodyDoc;
let mateLogo;
if (document.querySelector("body") !== undefined) bodyDoc = document.querySelector("body");
if (document.querySelector(".logo") !== undefined) mateLogo = document.querySelector(".logo");
const promise1 = ()=>{
